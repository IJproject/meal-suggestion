    ...
    <AuthenticatedLayout>
        <div>
            ...
            <form @submit.prevent="submit" class="mx-10 mt-4 p-6 bg-white shadow-lg space-y-6">
                <label>
                    タイトル
                    <input v-model="form.title" class="block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500">
                </label>
                <label>
                    本文
                    <textarea v-model="form.content" class="block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500"></textarea>
                </label>
